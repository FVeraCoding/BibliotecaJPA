...
public class EmpleadoJpaController implements Serializable {
    ...
    public void create(Empleado empleado) {
        ...
        try {
            ...
            em.persist(empleado);
            if (usuario != null) {
                Empleado oldEmpOfUsuario = usuario.getEmp();
                if (oldEmpOfUsuario != null) {
                    oldEmpOfUsuario.setUsuario(null);
                    oldEmpOfUsuario = em.merge(oldEmpOfUsuario);
                }
                usuario.setEmp(empleado);
    ...
    public void edit(Empleado empleado) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (usuarioOld != null && !usuarioOld.equals(usuarioNew)) {
                usuarioOld.setEmp(null);
                usuarioOld = em.merge(usuarioOld);
            }
            if (usuarioNew != null && !usuarioNew.equals(usuarioOld)) {
                Empleado oldEmpOfUsuario = usuarioNew.getEmp();
                if (oldEmpOfUsuario != null) {
                    oldEmpOfUsuario.setUsuario(null);
                    oldEmpOfUsuario = em.merge(oldEmpOfUsuario);
                }
                usuarioNew.setEmp(empleado);
